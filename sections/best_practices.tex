...
UIUC assignments of all sizes — from 10-page weekly reports to a 500-page
...
and footers. Because this template places \texttt{UNIVERSITY OF ILLINOIS URBANA-CHAMPAIGN}
...
\begin{itemize}
    ...
    \item Your lecturer's copy (with the UIUC header) and your Turnitin
